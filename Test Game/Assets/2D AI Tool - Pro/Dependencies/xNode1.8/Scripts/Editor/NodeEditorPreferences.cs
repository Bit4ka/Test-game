...
namespace XNodeEditor {
    public enum NoodlePath { Curvy, Straight, Angled, ShaderLab, AITool }
    ...
    public static class NodeEditorPreferences {
        ...
        private static void NodeSettingsGUI(string key, Settings settings) {
            ...
            settings.advancedMenu = EditorGUILayout.Toggle("Advanced menu", settings.advancedMenu);
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    allDefines.Add("USE_ADVANCED_GENERIC_MENU");
                }
                else
                {
                    allDefines.Remove("USE_ADVANCED_GENERIC_MENU");
                }
