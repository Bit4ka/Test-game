...
namespace XNode
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        public class InputAttribute : Attribute
        {
            ...
            public InputAttribute(ShowBackingValue backingValue = ShowBackingValue.Never, ConnectionType connectionType = ConnectionType.Multiple, TypeConstraint typeConstraint = TypeConstraint.None, bool dynamicPortList = false)
            {
